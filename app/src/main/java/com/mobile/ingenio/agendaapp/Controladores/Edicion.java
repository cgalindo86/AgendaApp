...
public class Edicion extends AppCompatActivity {
    ...
    String elmunicipio,eldepartamento,sjefes,sdelegados;
    String jefeElegido,delegadoElegido,departamentoElegido,municipioElegido;
    EditText nomEvento,fechaE,horaI,horaF,nombreOrg,direvento,televento;
    TextView municipio,departamento,jefe,delegado;
    Spinner jefes,delegados,municipios,departamentos;
    int codJefe,codDelegado,codDepartamento,codMunicipio;
    ...
    final int anio2 = c.get(Calendar.YEAR);
    ...
    String ntitulo,nfecha,nhoraInicio,nhoraFin,njefe,ndelegado,ndepartamento,nmunicipio,nnombre,ndireccion,ntelefono,nid;
    Button guardar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nomEvento = (EditText) findViewById(R.id.nomevento);
        fechaE = (EditText) findViewById(R.id.fechaE);
        horaI = (EditText) findViewById(R.id.horaI);
        horaF = (EditText) findViewById(R.id.horaF);
        nombreOrg = (EditText) findViewById(R.id.nombreOrg);
        direvento = (EditText) findViewById(R.id.direvento);
        televento = (EditText) findViewById(R.id.televento);
        departamento = (TextView) findViewById(R.id.departamento);
        municipio = (TextView) findViewById(R.id.municipio);
        jefe = (TextView) findViewById(R.id.tjefe);
        delegado = (TextView) findViewById(R.id.tdelegado);
        guardar = (Button) findViewById(R.id.addEvento);
        ...
        jefes = (Spinner) findViewById(R.id.jefe);
        ArrayAdapter<String> adapter2;
        adapter2 = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,sjefes2);
        ...
        delegados = (Spinner) findViewById(R.id.delegado);
        ArrayAdapter<String> adapter3;
        adapter3 = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,sdelagdos2);
        ...
        departamentos = (Spinner) findViewById(R.id.ddepartamento);
        municipios = (Spinner) findViewById(R.id.dmunicipio);

        final String sdepartamentos[] = ("Cambiar Departamento#"+ConvertDepartamentos()).split("#");

        ArrayAdapter<String> adapter4;
        adapter4 = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,sdepartamentos);
        ...
        String even[] = eventos.getEventoElegido(getApplicationContext()).split("#");
        Log.d("ee",eventos.getEventoElegido(getApplicationContext()));
        nid = even[0];
        fechaE.setText(even[1]);
        horaI.setText(even[2]);
        horaF.setText(even[3]);
        nomEvento.setText(even[4]);
        direvento.setText(even[5]);
        elmunicipio = Municipio(even[6]); municipioElegido  = elmunicipio;
        eldepartamento = Departamento(even[6]); departamentoElegido = eldepartamento;
        municipio.setText(elmunicipio);
        departamento.setText(eldepartamento);
        nombreOrg.setText(even[9]);
        direvento.setText(even[5]);
        televento.setText(even[10]);
        jefe.setText(Usuarios(even[12]));
        jefeElegido = Usuarios(even[12]);
        if(even[12].equals(" ") || (even[12].equals(""))){
            codJefe = 0;
        } else {
            codJefe = Integer.parseInt(even[12]);
        }

        delegado.setText(Usuarios(even[13]));
        delegadoElegido = Usuarios(even[13]);
        if(even[13].equals(" ") || (even[13].equals(""))){
            codDelegado = 0;
        } else {
            codDelegado = Integer.parseInt(even[13]);
        }
        ...
        ib_Obtener_hora1 = (ImageView) findViewById(R.id.ib_obtener_hora1);
        ...
        ib_Obtener_hora2 = (ImageView) findViewById(R.id.ib_obtener_hora2);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    eventos1.setEventoAlmacenadoEd(getApplicationContext(),alm);
                }
            }
        });
    }
    ...
    private String ConvertDelegado(){
        ...
        String d[] = delegado.getDelegados(getApplicationContext()).split("%");
        int n = d.length;
    ...
    private String ConvertDepartamentos(){
        String resp = "";
        Departamentos departamentos = new Departamentos();
        String d[] = departamentos.getDepartamentos(getApplicationContext()).split("%");
        int n = d.length;
    ...
    void SpinnerMunicipio(int codDepartamento){
        ...
        ArrayAdapter<String> adapter4;
        adapter4 = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,smunicipios);
    ...
    private class EnvioData extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            progressDoalog = new ProgressDialog(Edicion.this);
    ...
    public class LeeUsuario2 extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(p[0].equals("1")){
                ...
                Intent i = new Intent(Edicion.this,MainActivity.class);
                startActivity(i);
            }
